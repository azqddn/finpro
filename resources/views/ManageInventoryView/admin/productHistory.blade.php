                    ...
                    <div class="d-flex justify-content-between align-items-center pe-0" style="">
                        ...
                        <div class="dropdown me-1">
                            ...
                            <ul class="dropdown-menu dropdown-menu-dark">
                                <li><a class="dropdown-item" href="{{ route('display.product.history.owner', ['sort' => 'a_to_z']) }}">From A to Z</a></li>
                                <li><a class="dropdown-item" href="{{ route('display.product.history.owner', ['sort' => 'price_low_high']) }}">Price Low to High</a></li>
                                <li><a class="dropdown-item" href="{{ route('display.product.history.owner', ['sort' => 'price_high_low']) }}">Price High to Low</a></li>
                                <li><a class="dropdown-item" href="{{ route('display.product.history.owner', ['sort' => 'cost_low_high']) }}">Cost Low to High</a></li>
                                <li><a class="dropdown-item" href="{{ route('display.product.history.owner', ['sort' => 'cost_high_low']) }}">Cost High to Low</a></li>
                            </ul>
                        </div>
                    </div>
