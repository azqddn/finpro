            ...
            <div class="mt-4 me-3 row justify-content-center" style="width:95%; height:auto; margin-left:20px">
                ...
                <div class="row justify-content-center px-4"
                    ...
                    <div class="d-flex align-items-center px-0" style="height: 80px; width:100%;">
                        ...
                        <div class="dropdown me-5">
                            ...
                            <ul class="dropdown-menu dropdown-menu-dark">
                                <li><a class="dropdown-item"
                                        href="{{ route('display.product.owner', ['sort' => 'a_to_z']) }}">From A to Z</a>
                                </li>
                                <li><a class="dropdown-item"
                                        href="{{ route('display.product.owner', ['sort' => 'price_low_high']) }}">Price Low
                                        to High</a></li>
                                <li><a class="dropdown-item"
                                        href="{{ route('display.product.owner', ['sort' => 'price_high_low']) }}">Price High
                                        to Low</a></li>
                                <li><a class="dropdown-item"
                                        href="{{ route('display.product.owner', ['sort' => 'cost_low_high']) }}">Cost Low to
                                        High</a></li>
                                <li><a class="dropdown-item"
                                        href="{{ route('display.product.owner', ['sort' => 'cost_high_low']) }}">Cost High
                                        to Low</a></li>
                                <li><a class="dropdown-item"
                                        href="{{ route('display.product.owner', ['sort' => 'low_stock']) }}">Low/Out of
                                        Stock</a></li>
                                <li><a class="dropdown-item"
                                        href="{{ route('display.product.owner', ['sort' => 'expired_soon']) }}">Expired/Expiry
                                        Soon</a></li>
                            </ul>
                        </div>
                        ...
                        {{-- Add Product icon --}}
                        <div class="me-3">
                            <a href="{{ route('add.product.owner') }}" style="text-decoration: none;">
                    ...
                    <div class="d-flex ps-0 align-items-center justify-content-start">
                        <div class="d-flex align-items-center me-3">
                            <span style="border: 1px solid #494949; width: 12px; height: 12px; background-color: yellow;"></span>
                            <span class="ms-2 small">Expiry Alert</span>
                        </div>
                        <div class="d-flex align-items-center">
                            <span style="border: 1px solid #494949; width: 12px; height: 12px; background-color: rgb(255, 68, 68);"></span>
