                    ...
                    <div class="my-3 mt-4 px-0 d-flex justify-content-between align-items-center" style="">
                            ...
                            <ul class="dropdown-menu dropdown-menu-dark">
                                <li>
                                    <a class="dropdown-item"
                                        href="{{ route('staff.display.report', ['sort' => 'oldest_first']) }}">Oldest
                                        First</a>
                                        <a class="dropdown-item"
                                        href="{{ route('staff.display.report', ['sort' => 'latest_first']) }}">Latest
                                        First</a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="mt-2 d-flex justify-content-center align-items-center ms-5"
                            ...
                            <div class="d-flex align-items-center pt-3 px-2"
                                ...
                                <form action="{{ route('staff.display.report') }}" method="GET"
                        ...
                        {{-- New Report Button --}}
                        <div>
                            <a href="{{ route('staff.report.create') }}" style="text-decoration: none;">
