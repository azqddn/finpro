        ...
        <div class="d-flex justify-content-center" style="width: 100%; height:auto">
            <div class="row justify-content-center" style="width: 70%">
                ...
                <div class="mt-3 mb-3 row justify-content-center"
                    style="background-color:rgb(255, 255, 255);border:1px solid rgb(185, 185, 185); box-shadow: 7px 7px 5px rgb(214, 214, 214); border-radius:10px; width:100%; height:auto">
                        ...
                        <div id="top-profile" class="d-flex justify-content-between align-items-start my-4"
                            ...
                            <div class="align-self-end">
                                <a href="{{ url('admin/edit/' . $company->id . '/company') }}">
                                    <button style="width: 80px;height:35px; background-color:rgb(28, 28, 255); border:1px solid rgb(28, 28, 255); border-radius:5px; color:white">Edit</button>
                                </a>
                            </div>
                        </div>
