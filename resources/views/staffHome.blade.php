                ...
                <div class="row px-0" style="width: 100%; height:auto">
                    ...
                    <div class="d-flex px-0 mb-4 justify-content-between" style="width:100%; height:auto">
                        ...
                        <div class="d-flex justify-content-center align-items-center"
                            style="background-color:white;  border:2px solid rgb(82, 99, 255); color:rgb(82, 99, 255); width:30%; height:100px; border-radius:30px; box-shadow: 2px 3px 6px #4b4b4b42;">
                        ...
                        {{-- 2nd box --}}
                        <div class="d-flex justify-content-center align-items-center"
                            style="background-color:rgb(255, 255, 255); border:2px solid rgb(248, 137, 161); color:rgb(255, 105, 138); width:30%; height:100px; border-radius:30px; box-shadow: 2px 3px 6px #4b4b4b42;">
                            <div class="m-3 px-3 text-start" style="width:100%; height:auto;">
                        ...
                        {{-- 3rd box --}}
                        <div class="d-flex justify-content-center align-items-center"
                            style="background-color:rgb(255, 255, 255); border:2px solid rgb(109, 109, 109); color:rgb(109, 109, 109); width:30%; height:100px; border-radius:30px; box-shadow: 2px 3px 6px #4b4b4b42;">
                            <div class="m-3 px-3 text-start" style="width:100%; height:auto;">
            ...
            var balanceChart = new Chart(ctxLine, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        data: @json($balances),
                        backgroundColor: 'rgb(255, 221, 228)',
