            ...
            <div class="mt-4 me-3 row justify-content-center" style="width:95%; height:auto; margin:7px">
                ...
                <div class="row px-0" style="width: 100%; height:auto">
                    ...
                    <div class="d-flex px-0 mb-4 justify-content-between"
                        ...
                        {{-- 2nd box --}}
                        <div class="d-flex justify-content-center align-items-center"
                            style="background-color:rgb(149, 92, 255); color:white; width:30%; height:100px; border-radius:30px; box-shadow: 2px 3px 6px #4b4b4b42;">
                            <div class="m-3 px-3 text-start" style="width:100%; height:auto;">
            ...
            var revenueExpensesChart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                            ...
                            borderColor: 'rgb(47, 47, 255)',
                            borderWidth: 1
                        },
                        {
                            label: 'Expenses',
                            data: @json($expenses),
                            backgroundColor: 'rgb(221, 203, 255)',
                            borderColor: 'rgb(139, 76, 255)',
                            borderWidth: 1
                        }
                    ]
                },
            ...
            var balanceChart = new Chart(ctxLine, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        borderColor: 'rgb(139, 76, 255)',
                        borderWidth: 2,
                        pointBackgroundColor: 'rgb(139, 76, 255)',
                        pointRadius: 4,
                        fill: true
                    }]
                },
