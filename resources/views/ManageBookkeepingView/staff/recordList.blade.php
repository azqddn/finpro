                ...
                <div class="row justify-content-center mb-5"
                    ...
                    <div class="d-flex justify-content-between align-items-center pt-4">
                        <div class="d-flex justify-content-center" style="flex: 1;">
                            ...
                            <div class="d-flex align-items-center pt-3 ps-2 pe-2"
                                ...
                                {{-- Seach Input --}}
                                <form action="{{ route('display.record.staff') }}" method="GET"
                        ...
                        <div class="dropdown" style="margin-left: auto; margin-right: 0px;">
                            ...
                            <ul class="dropdown-menu dropdown-menu-dark">
                                <li><a class="dropdown-item"
                                        href="{{ route('display.record.staff', ['sort' => 'revenue_low_high']) }}">Revenue
                                        Low to High</a></li>
                                <li><a class="dropdown-item"
                                        href="{{ route('display.record.staff', ['sort' => 'revenue_high_low']) }}">Revenue
                                        High to Low</a></li>
                                <li><a class="dropdown-item"
                                        href="{{ route('display.record.staff', ['sort' => 'expense_low_high']) }}">Expense
                                        Low to High</a></li>
                                <li><a class="dropdown-item"
                                        href="{{ route('display.record.staff', ['sort' => 'expense_high_low']) }}">Expense
                                        High to Low</a></li>
                                <li><a class="dropdown-item"
                                        href="{{ route('display.record.staff', ['sort' => 'balance_low_high']) }}">Balance
                                        Low to High</a></li>
                                <li><a class="dropdown-item"
                                        href="{{ route('display.record.staff', ['sort' => 'balance_high_low']) }}">Balance
                                        High to Low</a></li>
                            </ul>
                        </div>
                    ...
                    <script>
                        document.getElementById('openButton')?.addEventListener('click', function() {
                            fetch('{{ route('store.open.record.staff') }}', {
                                    method: 'POST',
                                    headers: {
                        ...
                        document.getElementById('closeButton')?.addEventListener('click', function() {
                            fetch('{{ route('store.close.record.staff') }}', {
                                    method: 'POST',
                                    headers: {
                                        'X-CSRF-TOKEN': '{{ csrf_token() }}',
                                        'Content-Type': 'application/json',
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('store.record.staff') }}" method="POST" enctype="multipart/form-data">
                    @csrf
...
<script>
    ...
    function addDropdown() {
        ...
        function populateModal(record) {
            ...
            const removeForm = `/staff/bookkeeping/${record.id}/record/remove`;
