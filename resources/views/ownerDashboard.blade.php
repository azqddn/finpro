        ...
        <div class="d-flex justify-content-center" style="width: 100%; height:auto">
            ...
            <div class="mt-4 me-3 row justify-content-center" style="width:95%; height:auto; margin:7px">
                ...
                <div class="row px-0" style="width: 100%; height:auto">
                    ...
                    {{-- lvl 1 chart --}}
                    <div class="d-flex px-0 mb-4 justify-content-between"
                    ...
                    <div class="d-flex px-0 mb-4" style="width:100%; height:auto;">
                        ...
                        <div class="me-3 p-3 d-flex justify-content-center text-center" style="background-color: white; border-radius: 5px; box-shadow: 2px 3px 6px #4b4b4b42; width:50%; height:300px">
                            <div class="m-2" style="width:100%; height:100%">
                                <p class="h5">Monthly Balance</p>
                                <div class="d-flex justify-content-center align-items-center" style="width: 100%; height:85%">
                        ...
                        <div class="p-3 d-flex justify-content-center text-center" style="background-color: white; border-radius: 5px; box-shadow: 2px 3px 6px #4b4b4b42; width:50%; height:300px">
                    ...
                    <div class="d-flex px-0 mb-4" style="width:100%; height:auto">
                        ...
                        {{-- Product Sales Trend --}}
                        <div class="me-3 p-3 d-flex justify-content-center text-center" style="background-color: white; border-radius: 5px; box-shadow: 2px 3px 6px #4b4b4b42; width:50%; height:auto">
                            <div class="m-2" style="width:100%; height:100%">
                                <p class="h5">Product Sales Trend</p>
                                <div class="d-flex justify-content-center align-items-center" style="width: 100%; height: 800px;">
                        ...
                        <div class="p-3 d-flex justify-content-center text-center" style="background-color: white; border-radius: 5px; box-shadow: 2px 3px 6px #4b4b4b42; width:50%; height:auto">
                            <div class="" style="width:100%; height:100%">
