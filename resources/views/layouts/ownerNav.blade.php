    ...
    <div style="width: 15%; height:100vh; position:fixed;">
        <div id="sidebar" class="d-flex flex-column flex-shrink-0 p-3"
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                {{-- Inventory --}}
                <li id="menu-list"
                    class="{{ request()->routeIs('display.product.owner', 'add.product.owner', 'edit.product.owner', 'display.product.history.owner', 'display.product.alert.owner', 'display.edit.history') ? 'active' : '' }}"
                    style="margin-bottom: 10px">
                ...
                {{-- Bookkeeping --}}
                <li id="menu-list" class="{{ request()->routeIs('display.record.owner') ? 'active' : '' }}"
                    style="margin-bottom: 10px">
                ...
                {{-- Report --}}
                <li id="menu-list" class="{{ request()->routeIs('owner.report.create', 'owner.display.report') ? 'active' : '' }}"
                    style="margin-bottom: 10px">
                    <a href="{{ route('owner.display.report') }}" class="nav-link link-dark">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"
                            fill="currentColor">
                            <path
