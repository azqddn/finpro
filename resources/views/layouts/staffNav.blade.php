    ...
    <div style="width: 15%; height:100vh; position:fixed;">
        <div id="sidebar" class="d-flex flex-column flex-shrink-0 p-3"
            ...
            <a class="ms-3" href="{{ route('owner.home') }}" style="width: 100%; height:50px">
                <svg width="110" height="auto" viewBox="0 0 498 153" fill="none"
                    ...
                    <path
                        ...
                        fill="white" />
                    <path d="M0.644669 77.0208L12.6655 65L60.0416 112.376L48.0208 124.397L0.644669 77.0208Z"
                        fill="white" />
                    <path d="M0.644669 77.0208L48.0208 29.6447L60.0416 41.6655L12.6654 89.0416L0.644669 77.0208Z"
                        fill="white" />
                    <path d="M35.9999 41.6654L48.0208 29.6447L95.3969 77.0207L83.376 89.0416L35.9999 41.6654Z"
                        fill="white" />
                    <path d="M35.9999 112.376L83.376 64.9998L95.3969 77.0207L48.0208 124.397L35.9999 112.376Z"
                        fill="white" />
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                {{-- Report --}}
                <li id="menu-list" style="margin-bottom: 10px" class="{{ request()->routeIs('staff.report.create', 'staff.display.report') ? 'active' : '' }}">
                    <a href="{{ route('staff.display.report') }}" class="nav-link link-dark">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"
                            fill="currentColor">
                            <path
            ...
            <div class="dropdown">
                <a href="#" id="dropdown-toggle"
                    ...
                    {{-- User's Name --}}
                    <strong style="color: rgb(255, 255, 255); width:auto; height:auto">{{ Auth::user()->name }}</strong>
                </a>
                <ul class="dropdown-menu text-small shadow" aria-labelledby="dropdownUser2">
                    <li><a class="dropdown-item" href="{{ route('display.profile.staff') }}">Profile</a></li>
                    <li>
                        <hr class="dropdown-divider">
                    </li>
                    <li>
                        <a class="dropdown-item" href="{{route('display.company.staff')}}">Company</a>
                    </li>
                    <li>
                        <hr class="dropdown-divider">
                    </li>
