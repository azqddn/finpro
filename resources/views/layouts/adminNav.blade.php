...
<head>
    ...
    <link rel="icon" type="image/svg+xml" href="{{ asset('\assets\FinproLogo2.svg') }}">
    ...
    <div style="width: 15%; height:100vh; position:fixed">
        <div id="sidebar" class="d-flex flex-column flex-shrink-0 p-3"
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                {{-- Report --}}
                <li id="menu-list" style="margin-bottom: 10px" class="{{ request()->routeIs('admin.report.create', 'admin.display.report') ? 'active' : '' }}">
                    <a href="{{ route('admin.display.report') }}" class="nav-link link-dark">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"
                            fill="currentColor">
                            <path
